...
subtitle: "<span style='font-size:1.75em;line-height:1.1;'>Workshops for Ukraine</span></span>"
...
##  {background-image="img/avatars.png" background-position="center" background-size="77%"}
...
```{r}
#| label: prep
#| code-line-numbers: "1,2,3|5|7,13|8,9,10,11,12|8|9,10|11,12"
library(ggplot2)
library(dplyr)
library(prismatic)
...
theme_update(
  ...
  plot.title = element_text(face = "bold", size = rel(1.5), margin = margin(b = 15)),
  plot.title.position = "plot",
  plot.caption = element_text(color = "grey45", size = rel(.7), hjust = 0, margin = margin(t = 15)),
...
```{r, echo=3:22}
#| label: data-prep
#| code-line-numbers: "1,2|4|5,11|6,7,8,9|10|12,13,14,15|16|17|19|20|21"
library(tidyverse)
